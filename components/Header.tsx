    ...
    return (
        <div>
            <div className={`w-full flex-row ${containerStyles}`}>
                <header className="flex relative w-full items-center">
                    ...
                    <nav className="lg:flex w-full justify-center hidden items-center gap-8">
                        <Link href=""
                              className="font-bold text-center h-[2rem] duration-100 hover:border-b-2 border-b-black tracking-wider line-clamp-1 text-2xl"
                              onMouseEnter={() => dispatch(setShowMenu(true))}>Women</Link>
                        <Link href=""
                              className="font-bold duration-100 h-[2rem] hover:border-b-2 -tracking-wider border-b-black line-clamp-1 text-2xl"
                              onMouseEnter={() => dispatch(setShowMenu(true))}>Men</Link>
                    </nav>
                    <div className="flex absolute items-center justify-center right-0 top-0">
            ...
            <div onMouseOut={() => dispatch(setShowMenu(false))} onMouseOver={() => dispatch(setShowMenu(true))}
                 className={`w-[100vw] -z-50  absolute gap-12 justify-center items-center duration-[800ms] transition-all ${showMenu ? 'top-[3rem] z-50' : '-top-[100%]'} `}>
